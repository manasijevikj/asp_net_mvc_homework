    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Pizzas",
                columns: new[] { "Id", "IsOnPromotion", "Name", "PizzaSize", "Quantity" },
                values: new object[,]
                {
                    { 1, true, "Kaprichioza", 0, 0 },
                    { 2, false, "Pepperoni", 0, 0 },
                    { 3, false, "Margarita", 0, 0 }
                });
            ...
            migrationBuilder.InsertData(
                table: "PizzaOrder",
                columns: new[] { "Id", "OrderId", "PizzaId", "PizzaSize", "Quantity" },
                values: new object[] { 1, 1, 1, 1, 0 });

            migrationBuilder.InsertData(
                table: "PizzaOrder",
                columns: new[] { "Id", "OrderId", "PizzaId", "PizzaSize", "Quantity" },
                values: new object[] { 2, 1, 2, 2, 0 });

            migrationBuilder.InsertData(
                table: "PizzaOrder",
                columns: new[] { "Id", "OrderId", "PizzaId", "PizzaSize", "Quantity" },
                values: new object[] { 3, 2, 2, 2, 0 });
