...
namespace SEDC.PizzaApp.Services.Implementations
{
    public class FeedbackService : IFeedbackService
    {
        ...
        public void UpdateFeedback(FeedbackViewModel feedbackViewModel)
        {
            ...
            feedbackDb.Name = feedbackViewModel.Name;
            feedbackDb.Email = feedbackViewModel.Email;
            feedbackDb.Message = feedbackViewModel.Message;

            // tukaaaaaa delete za id 1
            //_feedbackRepository.DeleteById(feedbackDb.Id);
            //DeleteFeedback(feedbackDb.Id);

            _feedbackRepository.Update(feedbackDb);
